...
class SecurityTester:
    ...
    def print_banner(self):
        ...
        print("""
ðŸ”´ TESTS DE SÉCURITÉ AUTOMATISÉS
==================================
âš ï¸  ATTENTION: Tests d'intrusion en cours
🎯 Cible: HoneyPot Pro Max
ðŸ“Š Monitoring: Vérifiez Kibana pour les alertes
        """)
    ...
    def test_brute_force(self, attempts: int = 20) -> Dict:
        ...
        if results["detected"]:
            print("ðŸ” Détection Snort: ACTIVÉE")
        else:
            print("âš ï¸  Détection Snort: NON DÉTECTÉE")
        ...
        for code in invalid_codes:
            try:
                ...
                if response.status_code in [401, 400]:
                    ...
                    print(f"   Code {code}: ACCEPTÉ âš ï¸")
                    results["successful_bypass"] += 1
    ...
    def generate_report(self, results: Dict):
        ...
        print(f"""
ðŸ“Š RAPPORT DE TESTS DE SÉCURITÉ
===============================
ðŸ• Timestamp: {results['timestamp']}
🎯 Cible: {results['target']}
ðŸ§ª Tests exécutés: {len(results['tests'])}
...
""")
        ...
        for test in results["tests"]:
            ...
            detected = "… DÉTECTÉ" if test.get("detected", False) else "âš ï¸ NON DÉTECTÉ"
...
ðŸ“ Rapport sauvegardé: security_test_report.json
        """)
...
def main():
    ...
    parser.add_argument("--scenario", 
                       ...
                       default="all",
                       help="Scénario de test é  exécuter")
